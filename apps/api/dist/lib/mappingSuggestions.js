...
function repairMojibakeTurkish(value) {
    return value
        .replace(/\u00e3\u00a7|\u00e3\u2021/g, "c") // � / � => c
        .replace(/\u00e4\u00b1|\u00e4\u00b0/g, "i") // � / � => i
        .replace(/\u00e3\u00b6|\u00e3\u2013/g, "o") // � / � => o
...
function scoreByTokens(source, target) {
...
export function scoreMatch(sourceText, targetText) {
...
export function rankMappingSuggestions(sourceText, candidates, limit = 3, minScore = 0.25) {
